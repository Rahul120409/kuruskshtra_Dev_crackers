...
export default function AIHairstyleConsultationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#090d16] text-slate-100 font-sans selection:bg-amber-500/30">
      {/* TOP HEADER - Clean, without the navigation links per user request */}
      <nav className="border-b border-[#1b2333] bg-[#0b0f19]/90 backdrop-blur px-4 py-2.5 flex items-center justify-between text-xs sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="px-2.5 py-1 rounded-lg border border-slate-700 bg-slate-800 text-slate-300 text-xs font-semibold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 bg-[#0f1422] border border-[#1d263b] rounded-2xl p-5 shadow-2xl">
            ...
            {isCameraOpen ? (
              ...
              /* SIDE-BY-SIDE: Original Upload on Left vs THAT EXACT PERSON WITH THE CUSTOMIZED HAIRCUT ON RIGHT */
              ...
              /* Full Look View of the User with Customized Haircut */
            ...
            {/* Quick Hairstyle Carousel (Selecting a style immediately changes the hair on the user's head) */}
            ...
            {/* Camera Action Buttons (Click Pic / Upload Photo) */}
